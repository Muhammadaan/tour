app.controller('konfirmasiCtrl', function($scope, Data, toaster) {
    var tableStateRef;
    var control_link = "appkonfirmasi";
    $scope.formTitle = '';
    $scope.displayed = [];
...
//        var url = (form.id > 0) ? '/update' : '/create';
    ...
    $scope.cancel = function() {
     ...
     $scope.trash = function (row) {
        ...
        Data.get(control_link + '/cek/' + row.id).then(function (data) {
          
                

                if (data.data.data != 0) {
                   toaster.pop('error', "Terjadi Kesalahan", "Berkas Di Gunakan ");
                } else {
    ...
    swal({
     ...
     $scope.delete = function (row) {
            ...
            swal({
          title: "Peringatan !",
          text: "Anda Akan Menghapus Permanent ",
          type: "warning",
          showCancelButton: true,
          confirmButtonColor: "#DD6B55",
