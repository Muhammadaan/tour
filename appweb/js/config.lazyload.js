angular.module('app').config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
    $ocLazyLoadProvider.config({
        ...
        modules: [{
            ...
            files: ['js/library/bootstrap-daterangepicker/daterangepicker.js', 'js/library/angular-daterangepicker/js/angular-daterangepicker.min.js', 'js/library/bootstrap-daterangepicker/daterangepicker-bs3.css']
        }, {
