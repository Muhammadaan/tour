 ...
 * get Gudang list
 */
$app->get('/m_text_slider/index', function ($request, $response) {
 ...
 * create
 */
$app->post('/m_text_slider/create', function ($request, $response) {
 ...
 * update cabang
 */
$app->post('/m_text_slider/update', function ($request, $response) {
    $data = $request->getParams();
 ...
 * delete user
 */
$app->delete('/m_text_slider/delete/{id}', function ($request, $response) {
    $db = $this->db;
...
$app->post('/m_text_slider/trash', function ($request, $response) {
    $data = $request->getParams();
